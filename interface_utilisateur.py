...
def questionnaire():
    ...
    print(
        "2: Quelles sont les caractéristiques (poids, taille, âge) qui remportent le plus de médailles?"
    )
    print("3: Quel est le classement des pays aux JO toutes années confondues?")
    print(
        "4: Quelle peuvent être une borne inférieure et une borne supérieure du nombre de médailles gagnées par pays pour les JO 2016?"
    )
    print(
        "5: Le nombre de disciplines accessibles aux hommes et aux femmes est-il équivalent? Les JO sont-ils devenus équitables? Si oui, depuis quand?"
    )
    print("6: Quel est le classement des athlètes toutes années confondues?")
    print(
        "7: Des disciplines pratiquées à des JO précédents ont-elles disparu? Si oui, lesquelles?"
    )
    print(
        "8: Quelle proportion des participants les femmes représentent-elles aux JO chaque année?"
    )
    print(
        "9: La Chine a-t-elle eu de meilleures performances durant les JO de Pékin en 2008 (par rapport à la moyenne de ses performances)? Est-ce le cas pour les jeux qui les ont précédés et suivis?"
    )
    print("10: Combien de médailles les pays ont-ils gagné en moyenne depuis 1896?")
    print(
        "11: Quelles disciplines vous correspondent le mieux en se basant sur les profils d'athlètes similaire ?"
    )

    question = input(
        "\nTapez le numéro de la question dont vous souhaitez avoir la réponse, tapez 0 pour quitter\n"
    )
    return question
...
def interface():
    ...
    while True:
        ...
        if question == "0":
            ...
            print(
                "Si vous souhaitez connaître le nombre de médaille cumulé d'un nom de votre choix, tapez 2\n"
            )
            choix = input()
            if choix == "1":
                print(
                    f"Le nombre total de médailles obtenues par Phelps est {Question_1('Michael Fred Phelps, II')}"
                )
            elif choix == "2":
                nom = input(
                ...
                print(
                    f"Le nombre total de médailles obtenues par {nom} est {Question_1(nom)}"
                )
            else:
            ...
            print(
                "Si vous souhaitez connaître le résultat pour une année de votre choix, tapez 2\n"
            )
            choix = input()
            if choix == "1":
                ...
                annee = int(
                    input(
                        "\nTapez le numéro de l'année dont vous souhaitez avoir la réponse\n"
                    )
                )
...
>>>>>>> c5c1702888a19d1b381923c18a127bea2a0d3bff
            ...
            print(
                "nous déterminons les 3 sports où vos caractéristiques ont le plus de chance de gagner une médaille"
            )
            choix = input(
                "\nSi vous voulez rentrer vos caractéristiques tapez 1, si vous voulez un exemple tapez 2"
            )
            if choix == "1":
                ...
                print(
                    "\nNous prendrons l'exemple ici d'un homme de 22 ans, de 175 cm et de 65 kg\n"
                )
