...
def questionnaire():
    ...
    print("11: Quelles disciplines vous correspondent le mieux en se basant sur les profils d'athlètes similaire ?")
...
def interface():
    ...
    while True:
        ...
        if question == "0":
            ...
            print("nous déterminons les 3 sports où vos caractéristiques ont le plus de chance de gagner une médaille")
            ...
            if choix == "1":
                ...
                sexe = int(input("Tapez 0 si vous êtes une femme, 1 si vous êtes un homme\n"))
