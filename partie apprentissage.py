...
def Question_apprentissage(poids, taille, age, sexe):
    # Charger les données
    ...
    def top_3_accuracy(model, X_test, y_test):
        ...
        for i in range(len(y_test)):
            # Obtenir l'indice des 3 sports les plus probables pour cet athlète
    ...
    return "Il s'agit d'estimation du sport le plus probable"
